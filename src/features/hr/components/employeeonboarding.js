...
function EmployeeOnBoarding(){
    ...
    useEffect(() =>{
        axios.get('http://localhost:8081/api/cap/jobtype',{
            headers:{
        ...
        axios.get('http://localhost:8081/api/cap/manager/all', {
...
const addEmployee = ()=>{
    ...
    axios.post('http://localhost:8081/api/cap/employee/add/' + managerId,
            data,
              {
                headers:{
                    'Authorization' : 'Basic ' + localStorage.getItem('token')
